 ...
 jTextArea2.setLineWrap(true);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (!(currentSce.equals(gameOver))) {
            ...
            if (currentSce.oneIsGood() == 1 && option1Radio.isSelected()) {
                game1.addScore(1);
            } else if (currentSce.oneIsGood() == 2 && option2Radio.isSelected()) {
                game1.addScore(1);
            } else {
                game1.addScore(-1);
            }
        ...
        try {
            ...
            while (i != -1) {//read chars until end of file
               ...
               // str2 += (char) i;
                ...
                Scenario sce = new Scenario(str, str2, str3, n);
                game1.addScenario(sce);
